    ...
    <li className="group" onClick={() => onMenuItemClick(name)}>
      ...
      >
        <div className="inline-block">
          <div
            className={`flex items-center group-hover:bg-primary-light group-hover:text-primary-base rounded-full pl-3 pr-8 py-3 transform transition-colors duration-200
